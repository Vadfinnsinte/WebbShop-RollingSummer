...
const EditProduct = ({product, setIsEdeting}) => {
    ...
    return (
        ...
        <div className="add-product-form">
            <label>Namn:</label>
            <input className={errors.picture ? "input-error" : "input-correct" } name="name" type="text" value={name} onChange={e => setName(e.target.value)} onBlur={(e) => handleValidation(e, errors, setErrors)}></input>
            <p className={errors.name ? 'error' : 'placeholder'}>{errors.name ? errors.name : 'Placeholder text'}</p>
        </div>
        <div className="add-product-form">
            <label>Kategori:</label>
            <input className={errors.picture ? "input-error" : "input-correct" } name="category" type="text" value={category} onChange={e => setCategory(e.target.value)} onBlur={(e) => handleValidation(e, errors, setErrors)}></input>
            <p className={errors.category ? 'error' : 'placeholder'}>{errors.category ? errors.category : 'Placeholder text'}</p>
        </div>
        <div className="add-product-form">
            <label>Pris:</label>
            <input className={errors.picture ? "input-error" : "input-correct" } name="price" type="number" value={price} onChange={e => setPrice(e.target.value)} onBlur={(e) => handleValidation(e, errors, setErrors)}></input>
